...
contract EpochNFTSplitManager is
    ...
    OwnableUpgradeable
{
    ...
    function initialize(address _condition, address _target)
        public
        initializer
    {
        __Ownable_init();
        condition = _condition; //NFTSplitAutomation
        target = _target; //NFTSplitAutomation
    }
